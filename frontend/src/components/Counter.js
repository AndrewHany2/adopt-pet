                ...
                <div className="row">
                    ...
                    <div className="col-md-3">
                        <div className="mr-2 counter">
                            ...
                            <img src={'resources/dog-in-front-of-a-man.png'} class="icon"/> 
                            </div>
                    ...
                    <div className="col-md-3">
                        <div className="mr-2 counter">
                            <div className="counter-icon">
                            <img src={'resources/pet-shelter.png'} class="icon"/> 
                            </div>
                    ...
                    <div className="col-md-3">
                        <div className="mr-2 counter">
                            <div className="counter-icon">
                            <img src={'resources/prize-badge-with-paw-print.png'} class="icon"/> 
                            </div>
